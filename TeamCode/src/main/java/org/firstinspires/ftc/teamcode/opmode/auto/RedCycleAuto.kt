...
class RedCycleAuto : CommandOpMode() {
    ...
    companion object {
        ...
        var leftPlacePose = Pose2d(47.5, -34.0, (-5).deg)
        var centerPlacePose = Pose2d(47.5, -32.0, 0.deg)
        var rightPlacePose = Pose2d(47.5, -43.0, 0.deg)
        var regularExitPose = Pose2d(-40.0, -13.0, 0.deg)
        var centerExitPose = Pose2d(-50.0, -13.0, 0.deg)
        var stackPose = Pose2d(-61.0, -17.0, 0.deg)
