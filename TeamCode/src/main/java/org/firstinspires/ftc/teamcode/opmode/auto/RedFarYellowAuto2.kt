...
@Autonomous
@JoosConfig
class RedFarYellowAuto2 : CommandOpMode() {
    ...
    companion object {
        ...
        var leftPlacePose = Pose2d(72.0, -37.0, (-5).deg)
        var centerPlacePose = Pose2d(72.0, -40.0, 0.deg)
        var rightPlacePose = Pose2d(72.0, -42.0, 0.deg)
